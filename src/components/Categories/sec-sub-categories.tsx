...
function SecSubCategories() {
    ...
    const handleSubmit = async (formData: any) => {
        try {
            ...
            const api = edit ? SecSubCategoriesApi.update : SecSubCategoriesApi.create
            const response = await api(formData);
            toast.success(response?.data?.message || `Secondary SubCategory ${edit ? "updated" : "created"} successfully`);
            handleClose()
        } catch (error: any) {
    ...
    const deleteCategory = async (id: number) => {
        try {
            ...
            toast.success(response?.data?.message || "Secondary SubCategory deleted successfully");
        } catch (error: any) {
    ...
    const { subCategories, isLoading: subCategoriesLoading } = useSubCategory(categoryId);
                                    ...
                                    render={({ field }) => (
                                        <FormItem className='w-full'>
                                            ...
                                            <Select onValueChange={field.onChange} value={field.value}>
                                                ...
                                                <SelectContent>
                                                    {categoriesLoading && <SelectItem value=" " disabled>Loading...</SelectItem>}
