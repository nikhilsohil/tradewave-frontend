...
import type { CreateResponce, CategoriesResponse } from "@/services/types/categories";
...
export default class CategoriesApi {
    ...
    static delete(id: number) {
        return httpClient.post<BaseResponse>(`/api/category/${id}`)
    }

    static getSubCategories(payload: any) {
        return httpClient.post<SubCategoriesResponse>('/api/category/getsubcategory', payload)
    }
}
