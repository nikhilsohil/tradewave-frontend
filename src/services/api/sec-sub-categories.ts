...
import type { CreateResponce, SecondSubCategoriesResponse } from "@/services/types/sec-sub-categories";

export default class SecSubCategoriesApi {
    static get(payload: any) {
        return httpClient.get<SecondSubCategoriesResponse>('/api/secsubcategory', payload)
    }
