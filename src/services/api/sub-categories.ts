...
import type { CreateResponce, SubCategoriesResponse } from "@/services/types/sub-categories";
...
export default class SubCategoriesApi {
    ...
    static getSecSubCategories(payload: any) {
        return httpClient.get<SecondSubCategoriesResponse>(`/api/subcategory/getSecSubCategories/`, payload)
    }
}
